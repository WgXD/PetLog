...
<table class="dotted-rounded-table">
	...
	<td>${dto.pet_name}</td>
	<td>${dto.pet_bog}</td>
	<td>${dto.pet_neuter}</td> <!-- 중성화 순서 바꿈 -->
	<td>${dto.pet_hbd}</td>
	<td><img src="./image/${dto.pet_img}" width="100px"/></td>

	<td><a href="pet_update?update=${dto.pet_id }&dfimage=${dto.pet_img}">✏️</a></td>
	<td><a href="pet_delete?delete=${dto.pet_id }&dfimage=${dto.pet_img}">🗑️</a></td>
	</tr>
